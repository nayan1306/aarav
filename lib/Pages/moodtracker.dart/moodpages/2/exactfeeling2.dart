...
class ExactFeelingPage2 extends StatefulWidget {
  final int moodScore;
  final List<Map<String, String>> selectedReasons;

  const ExactFeelingPage2({
    super.key,
  ...
  @override
  State<ExactFeelingPage2> createState() => _ExactFeelingPageState();
}

class _ExactFeelingPageState extends State<ExactFeelingPage2> {
