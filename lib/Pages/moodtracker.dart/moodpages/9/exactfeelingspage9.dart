...
class ExactFeelingPage9 extends StatefulWidget {
  final int moodScore;
  final List<Map<String, String>> selectedReasons;

  const ExactFeelingPage9({
    super.key,
  ...
  @override
  State<ExactFeelingPage9> createState() => _ExactFeelingPageState();
}

class _ExactFeelingPageState extends State<ExactFeelingPage9> {
