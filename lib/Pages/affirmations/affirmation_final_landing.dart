...
class AffirmationFinalLanding extends StatefulWidget {
  final String quote;
  final String imagePath;
  final bool isActive;

  const AffirmationFinalLanding({
    super.key,
    required this.quote,
  ...
  @override
  _AffirmationFinalLandingState createState() =>
      _AffirmationFinalLandingState();
}

class _AffirmationFinalLandingState extends State<AffirmationFinalLanding>
  ...
  @override
  void didUpdateWidget(covariant AffirmationFinalLanding oldWidget) {
